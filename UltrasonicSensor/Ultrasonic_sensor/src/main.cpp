...
void uart_init(unsigned int baud); // Function declaration
void uart_transmit(char data); // Function declaration
void uart_print(const char *str); // Function declaration
void uart_print_float(float value); // Function declaration
